...
#source('C:\\Users\\latwood\\Documents\\MyDocuments\\Windninja\\Iteration_Impact_Project\\IterationAnalyzer5.R')
...
plotOutput <- paste(extendedPath,"\\continuityErrors_SimulationTime.png", sep="")
png(filename=plotOutput,width=graphWidth,height=graphHeight)
...
plotOutput <- paste(extendedPath,"\\velocities.png", sep="")
png(filename=plotOutput,width=rasterGraphWidth,height=rasterGraphHeight)
...
plotOutput <- paste(extendedPath,"\\angles.png", sep="")
png(filename=plotOutput,width=rasterGraphWidth,height=rasterGraphHeight)
...
plotOutput <- paste(extendedPath,"\\velocityDifferences.png", sep="")
png(filename=plotOutput,width=rasterGraphWidth,height=rasterGraphHeight)
...
plotOutput <- paste(extendedPath,"\\angleDifferences.png", sep="")
png(filename=plotOutput,width=rasterGraphWidth,height=rasterGraphHeight)
