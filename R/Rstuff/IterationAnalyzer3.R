...
#source('C:\\Users\\latwood\\Documents\\MyDocuments\\Windninja\\Iteration_Impact_Project\\IterationAnalyzer3.R')
...
#some of these things I could probably put into a function since I'm repeating the same thing a lot. Especially the plots
	...
	par(oma=c(3,3,3,3),cex.lab=2,cex.axis=2,cex.sub=2,cex.main=2)
	plot(rVelocity,col=velocityColors,main="Velocities",cex.main=3)
	dev.off()
	...
	png(filename=plotOutput,width=graphWidth,height=graphHeight)
	par(oma=c(3,3,3,3),cex.lab=2,cex.axis=2,cex.sub=2,cex.main=2)
	plot(rAngle,col=angleColors,breaks=angleBreaks,main="Angles",cex.main=3)
	dev.off()
	...
	png(filename=plotOutput,width=graphWidth,height=graphHeight)
	par(oma=c(3,3,3,3),cex.lab=2,cex.axis=2,cex.sub=2,cex.main=2)
	plot(velocityDifference,col=velocityColors,main="Velocity Differences",cex.main=3)
	dev.off()
	...
	png(filename=plotOutput,width=graphWidth,height=graphHeight)
	par(oma=c(3,3,3,3),cex.lab=2,cex.axis=2,cex.sub=2,cex.main=2)
	plot(angleDifference,col=velocityColors,main="Angle Differences",cex.main=3)
	dev.off()
...
png(filename=plotOutput,width=graphWidth,height=graphHeight)
par(mfrow=c(3,3),oma=c(3,3,6,3),cex.lab=2,cex.axis=2,cex.sub=2,cex.main=2)
...
mtext("Ux, Uy, and Uz Summaries", outer = TRUE, cex = 3)
dev.off()
...
mtext("Pressure, k, and Epsilon Summaries", outer = TRUE, cex = 3)
dev.off()
...
mtext("Continuity Errors, Time Step for Final Iteration, and Total Simulation Time Summaries", outer = TRUE, cex = 3)
dev.off()
...
mtext("Iteration vs Error Plots", outer = TRUE, cex = 3)
dev.off()
...
png(filename=plotOutput,width=graphWidth,height=graphHeight)
par(oma=c(3,3,6,3),cex.lab=2,cex.axis=2,cex.main=2)
plot(rVelocityStack1,col=velocityColors)
mtext("Velocities 1",cex=3)
dev.off()
if (filecount > 16 )
{
...
mtext("Velocity Differences 1",cex=3)
dev.off()
if (filecount > 16)
{
	...
	mtext("Velocity Differences 2",cex=3)
	dev.off()
}
if (filecount > 32)
{
	...
	mtext("Velocity Differences 3",cex=3)
	dev.off()
}
...
mtext("Angle Differences 1",cex=3)
dev.off()
if (filecount > 16)
{
	...
	mtext("Angle Differences 2",cex=3)
	dev.off()
}
if (filecount > 32)
{
	...
	mtext("Angle Differences 3",cex=3)
	dev.off()
}
