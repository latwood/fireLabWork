...
#source('C:\\Users\\latwood\\Documents\\MyDocuments\\Windninja\\Iteration_Impact_Project\\textOutputGetter2.R')
...
commandTextFileName <- paste(extendedPath,"\\",rname," iterations\\command_output.txt", sep="")
...
sink(textOutput,append=TRUE)
cat(paste("\nThis is the iteration data for the ",rname," file:\n",sep=""))
