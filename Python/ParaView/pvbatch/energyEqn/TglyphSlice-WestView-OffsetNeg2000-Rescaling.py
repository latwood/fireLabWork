...
imgDir = mainDir+"/Pics/energyEqn/vshapedvalley-flatbot-notilt/buoyantBoussinesqPimpleFoam/Coarse/1mph0deg-reformedConditions/TglyphSlice-WestView-OffsetNeg2000-Rescaling/"
...
xSliceOffset = -2000			# this is the offset of the x slice starting point
