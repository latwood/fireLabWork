...
imgDir = mainDir+"/Pics/energyEqn/vshapedvalley-flatbot-notilt/buoyantBoussinesqPimpleFoam/Coarse/1mph0deg-reformedConditions/glyphsFull-WestView-Rescaling/"
...
viewCameraX = 0#500	# where in the x direction from the center do you want to position the object?
viewCameraY = -200#-300	# where in the y direction from the center do you want to position the object?
